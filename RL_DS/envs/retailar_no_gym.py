...
class RetailerOrders:
    ...
    def __init__(self,time):
        ...
        self.initial_cumulative_shipment = 0 # orders
        self.initial_cumulative_customer_demand = 0 # orders
        ...
        : flow costs
        """
        self.customer_demand = 100 # orders / weeks
        self.retailer_order = 0 # orders / weeks
        self.perceived_retailer_order = 100 # orders / weeks
        self.shipment_to_retailer = 100 # orders / weeks
        self.change_in_capacity = 0 # orders / weeks^2
        self.desired_shipment = self.backlog/self.target_delivery_delay # orders / weeks
        self.delivery_delay = 0 # weeks
        self.shipments = 100 # orders / weeks
        self.orders = 100 # orders / weeks
        ...
        : step
        """
        self.simulation_time = time # weeks
        self.dt = 1 # weeks
    ...
    # def reset(self):
        ...
        # self.target_delivery_delay = 10 # weeks
        # self.normal_capacity = 100 # Orders / weeks
        # self.supply_gap_cost_coefficient = 0.001 # USD / (weeks * orders^2)
        # self.order_cost_coefficient = 0.002 # USD / orders
        # """
        # Initialize levels
        # : initial level initial_backlog
        # : initial level initial_capacity
        ...
        # self.cumulative_customer_demand = [self.initial_cumulative_customer_demand]
        # self.retailer_total_cost = [self.initial_Retailer_total_cost]
        # self.desired_shipment = self.backlog/self.target_delivery_delay ##JC
        ...
        # self.shipment_to_retailer = 100 # orders / weeks
        # self.change_in_capacity = 0 # orders / weeks^2
        # self.desired_shipment = self.backlog/self.target_delivery_delay ##JC orders / weeks
        # self.delivery_delay = 0 # weeks
    ...
    def pulse(self,step, pulse_start =2, height = 20,pulse_end = 36):
    ...
    def run(self, actions):
        ...
        for i in range(self.simulation_time):
            ...
            self.cumulative_customer_demand += (self.customer_demand)*self.dt ###JCE está acumulando las órdenes y no la demanda
    ...
    def step(self, action : int):
        ...
        self.orders = self.retailer_order
        self.supply_gap = self.cumulative_customer_demand-self.cumulative_shipment ## JCE estaba mal escrito
        self.supply_gap_costs = self.supply_gap_cost_coefficient*(self.supply_gap**2) 
        self.retailer_costs = self.order_cost_coefficient*(self.retailer_order**2)
        self.costs = self.supply_gap_costs+self.retailer_costs

        # Definición de las ecuaciones diferenciales bajo método de Euler ###JCE las variables se actualizand después de los insumos
        self.backlog += (self.perceived_retailer_order-self.shipment_to_retailer)*self.dt
        
        
        
        self.retailer_total_cost += (self.costs)*self.dt ### no se puede calcular antes de costos para el periodo
    ...
    # env.customer_demand 
    # env.cumulative_customer_demand
    # env.cumulative_shipment
    # env.capacity
    # env.shipment_to_retailer
    # env.desired_shipment
    # env.backlog
    # env.perceived_retailer_order
    # env.cos
    # env.supply_gap
    # env.retailer_order**2*env.order_cost_coefficient
    # env.change_in_capacity
